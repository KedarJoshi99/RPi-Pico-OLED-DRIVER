...
/**
 * Configure the display controller structue
 *  @param oled oled instance
 *  @param i2c_instance i2c instance to which oled display is attached
 *  @param addr i2c address of oled display
 *  @param sda gpio to which display's SDA is connected
 *  @param scl gpio to which display's SCL is connected
 *  @param displayController Type of display controller either CTRL_SSD1306 or CTRL_SH1106
 *  @param height display height in pixels (H_16, H_32, H_64)
 *  @param width display width in pixels (W_96, W_128, W_132)
 */
